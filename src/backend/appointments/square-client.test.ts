...
describe('SquareAppointmentsClient', () => {
  ...
  describe('getAppointments', () => {
    ...
    it('should handle network errors', async () => {
      mockBookingsApi.listBookings.mockRejectedValue(new Error('Network error'))
  ...
  describe('getAppointmentById', () => {
    ...
    it('should handle appointment not found', async () => {
      ...
      await expect(client.getAppointmentById('non-existent')).rejects.toThrow(
        'Appointment with ID non-existent not found'
      )
    })
    ...
    it('should handle API errors', async () => {
      ...
      await expect(client.getAppointmentById('appointment-1')).rejects.toThrow(
